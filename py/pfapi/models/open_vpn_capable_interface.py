...
T = TypeVar("T", bound="OpenVPNCapableInterface")


@_attrs_define
class OpenVPNCapableInterface:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        open_vpn_capable_interface = cls(
            if_identity=if_identity,
            if_assigned_name=if_assigned_name,
        )

        open_vpn_capable_interface.additional_properties = d
        return open_vpn_capable_interface
