...
class User:
    ...
    Attributes:
        ...
        interfaces_sort (bool):
        webguicss (str):
        webguifixedmenu (str):
        webguihostnamemenu (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        ipsec_psk = d.pop("ipsec_psk")

        custom_settings = d.pop("custom_settings")

        interfaces_sort = d.pop("interfaces_sort")

        webguicss = d.pop("webguicss")

        webguifixedmenu = d.pop("webguifixedmenu")

        webguihostnamemenu = d.pop("webguihostnamemenu")

        dashboardcolumns = d.pop("dashboardcolumns")

        dashboardavailablewidgetspanel = d.pop("dashboardavailablewidgetspanel")

        systemlogsfilterpanel = d.pop("systemlogsfilterpanel")

        systemlogsmanagelogpanel = d.pop("systemlogsmanagelogpanel")

        statusmonitoringsettingspanel = d.pop("statusmonitoringsettingspanel")

        webguileftcolumnhyper = d.pop("webguileftcolumnhyper")

        disablealiaspopupdetail = d.pop("disablealiaspopupdetail")
