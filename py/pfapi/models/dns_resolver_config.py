...
class DNSResolverConfig:
    ...
    Attributes:
        ...
        active_interface (Union[Unset, str]):
        outgoing_interface (Union[Unset, str]):
    ...
    active_interface: Union[Unset, str] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        active_interface = d.pop("active_interface", UNSET)

        outgoing_interface = d.pop("outgoing_interface", UNSET)
