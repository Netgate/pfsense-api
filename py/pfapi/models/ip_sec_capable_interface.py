...
T = TypeVar("T", bound="IPSecCapableInterface")


@_attrs_define
class IPSecCapableInterface:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ip_sec_capable_interface = cls(
            if_identity=if_identity,
            if_assigned_name=if_assigned_name,
        )

        ip_sec_capable_interface.additional_properties = d
        return ip_sec_capable_interface
