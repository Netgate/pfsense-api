...
class OpenVPNServerConfig:
    ...
    Attributes:
        ...
        dco (bool | Unset):
        mode (str | Unset):
        authmode (list[str] | Unset):
        protocol (str | Unset):
        dev_mode (str | Unset):
        interface (str | Unset):
        local_port (int | Unset):
        description (str | Unset):
        tls (str | Unset): OpenVPN PEM TLS key
        ...
        maxclients (str | Unset):
        allow_compression (str | Unset): "asym", "yes", "no"
        dynamic_ip (bool | Unset):
        topology (str | Unset):
        ...
        ocspcheck (bool | Unset):
        ocspurl (str | Unset):
        ecdh_curve (str | Unset):
        autokey_enable (bool | Unset):
        shared_key (str | Unset):
        cert_depth (str | Unset):
        remote_cert_tls (bool | Unset):
        tunnel_networkv6 (str | Unset):
        serverbridge_dhcp (bool | Unset):
        serverbridge_interface (str | Unset):
        serverbridge_routegateway (bool | Unset):
        serverbridge_dhcp_start (str | Unset):
        serverbridge_dhcp_end (str | Unset):
        gwredir (bool | Unset):
        gwredir6 (bool | Unset):
        ...
        username_as_common_name (bool | Unset):
        udp_fast_io (bool | Unset):
        sndrcvbuf (str | Unset):
        create_gw (str | Unset):
        verbosity_level (str | Unset):
        strictusercn (bool | Unset):
    """
    ...
    compression_push: bool | Unset = UNSET
