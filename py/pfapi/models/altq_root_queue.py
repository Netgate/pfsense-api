...
class ALTQRootQueue:
    ...
    Attributes:
        ...
        enabled (bool | Unset):
        name (str | Unset): generated by system when create altq root queue
        qlimit (int | Unset): the number of packets that can be held in a queue waiting to be transmitted by the shaper,
            default size is 50
        tbrsize (int | Unset): adjusts the size, in bytes, of the token bucket regulator
