...
class FWAlias:
    ...
    Attributes:
        ...
        descr (str | Unset):
        type_ (FWAliasType | Unset): host, network, url, urltable, urltable_ports, port, or url_ports
        detail (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: FWAliasType | Unset
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = FWAliasType(_type_)
