...
class DNSForwarderConfigInfo:
    """
    Attributes:
        config (DNSForwarderConfig | Unset):
        interfaces (DNSForwarderConfigInfoInterfaces | Unset):
    """

    config: DNSForwarderConfig | Unset = UNSET
    interfaces: DNSForwarderConfigInfoInterfaces | Unset = UNSET
