...
class FWFilterRule:
    ...
    Attributes:
        ...
        disabled (bool | Unset):
        readonly (bool | Unset):
        floating (bool | Unset): floating rule
        ethernet (bool | Unset): ethernet rule
        gateway (str | Unset):
        tracker (str | Unset):
        type_ (str | Unset): pass, block, reject (non-ethernet), match (floating)
        interface (str | Unset):
        ipprotocol (str | Unset):
        tag (str | Unset):
        tagged (str | Unset):
        max_ (str | Unset):
        max_src_nodes (str | Unset):
        max_src_conn (str | Unset):
        max_src_states (str | Unset):
        statetimeout (str | Unset):
        statepolicy (str | Unset): "" (global default), if-bound, floating
        statetype (str | Unset):
        state (FWRuleState | Unset):
        os (str | Unset):
        protocol (str | Unset):
        direction (str | Unset):
        quick (bool | Unset):
        log (bool | Unset):
        dscp (str | Unset):
        allowopts (bool | Unset):
        disablereplyto (bool | Unset):
        nottagged (bool | Unset):
        pflow (str | Unset): "" (global default), "enabled", "disabled"
        max_src_conn_rate (str | Unset):
        max_src_conn_rates (str | Unset):
        tcpflags1 (str | Unset):
        tcpflags2 (str | Unset):
        tcpflags1_struct (TCPFlags | Unset):
        tcpflags2_struct (TCPFlags | Unset):
        tcpflags_any (bool | Unset):
        icmptype (str | Unset):
        nopfsync (bool | Unset):
        nosync (bool | Unset):
        vlanprio (str | Unset):
        vlanprioset (str | Unset):
        dnpipe (str | Unset): inbound pipe limiter
        pdnpipe (str | Unset): outbound pipe limiter
        ackqueue (str | Unset): acknowledgement shaper queue
        defaultqueue (str | Unset): default shaper queue
        bridgeto (str | Unset): ethernet rule, bridge to interface
        source (FWAddrPort | Unset):
        sched (str | Unset):
        destination (FWAddrPort | Unset):
        descr (str | Unset):
        srcmac (str | Unset): source MAC address for ethernet rule
        dstmac (str | Unset): destination MAC address for ethernet rule
        nat (FWFilterRuleNAT | Unset):
    ...
    max_src_nodes: str | Unset = UNSET
    max_src_conn: str | Unset = UNSET
    max_src_states: str | Unset = UNSET
    statetimeout: str | Unset = UNSET
    statepolicy: str | Unset = UNSET
    statetype: str | Unset = UNSET
    state: FWRuleState | Unset = UNSET
    os: str | Unset = UNSET
    ...
    allowopts: bool | Unset = UNSET
    disablereplyto: bool | Unset = UNSET
    nottagged: bool | Unset = UNSET
    pflow: str | Unset = UNSET
    max_src_conn_rate: str | Unset = UNSET
    max_src_conn_rates: str | Unset = UNSET
    tcpflags1: str | Unset = UNSET
    tcpflags2: str | Unset = UNSET
    tcpflags1_struct: TCPFlags | Unset = UNSET
    tcpflags2_struct: TCPFlags | Unset = UNSET
    tcpflags_any: bool | Unset = UNSET
    icmptype: str | Unset = UNSET
    nopfsync: bool | Unset = UNSET
    nosync: bool | Unset = UNSET
    vlanprio: str | Unset = UNSET
    vlanprioset: str | Unset = UNSET
    dnpipe: str | Unset = UNSET
    pdnpipe: str | Unset = UNSET
    ackqueue: str | Unset = UNSET
    defaultqueue: str | Unset = UNSET
    bridgeto: str | Unset = UNSET
    source: FWAddrPort | Unset = UNSET
    sched: str | Unset = UNSET
    destination: FWAddrPort | Unset = UNSET
    descr: str | Unset = UNSET
    srcmac: str | Unset = UNSET
    dstmac: str | Unset = UNSET
    nat: FWFilterRuleNAT | Unset = UNSET
