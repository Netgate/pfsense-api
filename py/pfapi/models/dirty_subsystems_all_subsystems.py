...
T = TypeVar("T", bound="DirtySubsystemsAllSubsystems")


@_attrs_define
class DirtySubsystemsAllSubsystems:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        dirty_subsystems_all_subsystems = cls()
        ...
        dirty_subsystems_all_subsystems.additional_properties = additional_properties
        return dirty_subsystems_all_subsystems
