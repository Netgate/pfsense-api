...
T = TypeVar("T", bound="VXLANCapableInterface")


@_attrs_define
class VXLANCapableInterface:
    """
    Attributes:
        if_device (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        vxlan_capable_interface = cls(
            if_device=if_device,
            if_assigned_name=if_assigned_name,
        )

        vxlan_capable_interface.additional_properties = d
        return vxlan_capable_interface
