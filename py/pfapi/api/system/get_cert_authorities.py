...
def _get_kwargs(
    *,
    withprivkey: Union[Unset, bool] = UNSET,
) -> Dict[str, Any]:
    params: Dict[str, Any] = {}
...
) -> Optional[Union[CertAuthorities, Error]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CertAuthorities, Error]]:
    return Response(
